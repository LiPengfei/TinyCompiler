...
char *stepResultTab[] = {
    ...
    "Data Memory Fault", "Devision by 0",
};
...
void writeInstruction(int loc){
    ...
    if ((loc >= 0) && (loc <IADDR_SIZE)) {
        ...
        switch (opClass(iMem[loc].iop)){
            case opclRR:
                printf("%3d,%3d", iMem[loc].iarg2, iMem[loc].iarg3);
                break;
            case opclRM:
            case opclRA:
                printf("%3d(%d)", iMem[loc].iarg2, iMem[loc].iarg3);
                break;
        }
    }
    printf("\n");
...
int doCommand(void){
    ...
    switch (cmd) {
        ...
        case 'h':
            ...
            printf("    g(o             Execute TM instructions until HALF\n");
            printf("    r(egs           Print the contants of the registers\n");
            ...
            printf("    h(elp           call this list of cmmands to printed\n");
            printf("    q(uit           Terminate the simulator\n");
            break;
        case 'p':
